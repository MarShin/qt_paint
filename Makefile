#############################################################################
# Makefile for building: pa2
# Generated by qmake (1.07a) (Qt 3.3.6) on: Fri Apr 10 23:29:51 2015
# Project:  pa2.pro
# Template: app
# Command: $(QMAKE) -o Makefile pa2.pro
#############################################################################
...
Makefile: pa2.pro  /usr/lib64/qt-3.3/mkspecs/linux-g++-64/qmake.conf /usr/lib64/qt-3.3/lib/libqt-mt.prl
	$(QMAKE) -o Makefile pa2.pro
qmake: 
	@$(QMAKE) -o Makefile pa2.pro

dist: 
	@mkdir -p .tmp/pa2 && $(COPY_FILE) --parents $(SOURCES) $(HEADERS) $(FORMS) $(DIST) .tmp/pa2/ && ( cd `dirname .tmp/pa2` && $(TAR) pa2.tar pa2 && $(GZIP) pa2.tar ) && $(MOVE) `dirname .tmp/pa2`/pa2.tar.gz . && $(DEL_FILE) -r .tmp/pa2
